...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <div style="margin-left:50px;" >
        <div class="col-md-12 testi_grid text-left" style="overflow-x:scroll;max-height:1000px"  >
            
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" OnRowUpdating="GridView1_RowUpdating1" AllowPaging="True" Style="background-size:cover; background-image:url(../img/1434.jpg)" >
        <Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bookclubConnectionString %>" DeleteCommand="DELETE FROM [product] WHERE [id] = @id" InsertCommand="INSERT INTO [product] ([cnm], [pid], [pnm], [price], [stock], [img], [des], [offer]) VALUES (@cnm, @pid, @pnm, @price, @stock, @img, @des, @offer,@discount)" SelectCommand="SELECT * FROM [product]" UpdateCommand="UPDATE [product] SET [cnm] = @cnm, [pid] = @pid, [pnm] = @pnm, [price] = @price, [stock] = @stock, [des] = @des, [offer] = @offer, [discount] = @discount WHERE [id] = @id">
        <DeleteParameters>
